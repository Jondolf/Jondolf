...
Currently, I am maintaining and developing [Avian](https://github.com/avianphysics/avian), a physics engine for the [Bevy game engine](https://bevyengine.org/), with a focus on modularity, ergonomics, and providing a native ECS-driven user experience. The Bevy ecosystem is in need of a native ECS-based physics engine, and my goal is to help reach that milestone. This project is my primary focus in terms of software development.
